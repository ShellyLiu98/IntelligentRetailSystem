...
public final class RecommendationServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "distsys.RecommendationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<distsys.generated.RecommendationRequest,
      distsys.generated.RecommendationResponse> getGetRecommendationsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetRecommendations",
      requestType = distsys.generated.RecommendationRequest.class,
      responseType = distsys.generated.RecommendationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<distsys.generated.RecommendationRequest,
      distsys.generated.RecommendationResponse> getGetRecommendationsMethod() {
    io.grpc.MethodDescriptor<distsys.generated.RecommendationRequest, distsys.generated.RecommendationResponse> getGetRecommendationsMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getGetRecommendationsMethod = RecommendationServiceGrpc.getGetRecommendationsMethod) == null) {
          RecommendationServiceGrpc.getGetRecommendationsMethod = getGetRecommendationsMethod =
              io.grpc.MethodDescriptor.<distsys.generated.RecommendationRequest, distsys.generated.RecommendationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetRecommendations"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.generated.RecommendationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.generated.RecommendationResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<distsys.generated.RecommendationRequest,
      distsys.generated.RecommendationResponse> getStreamRecommendationsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamRecommendations",
      requestType = distsys.generated.RecommendationRequest.class,
      responseType = distsys.generated.RecommendationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<distsys.generated.RecommendationRequest,
      distsys.generated.RecommendationResponse> getStreamRecommendationsMethod() {
    io.grpc.MethodDescriptor<distsys.generated.RecommendationRequest, distsys.generated.RecommendationResponse> getStreamRecommendationsMethod;
    if ((getStreamRecommendationsMethod = RecommendationServiceGrpc.getStreamRecommendationsMethod) == null) {
      synchronized (RecommendationServiceGrpc.class) {
        if ((getStreamRecommendationsMethod = RecommendationServiceGrpc.getStreamRecommendationsMethod) == null) {
          RecommendationServiceGrpc.getStreamRecommendationsMethod = getStreamRecommendationsMethod =
              io.grpc.MethodDescriptor.<distsys.generated.RecommendationRequest, distsys.generated.RecommendationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamRecommendations"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.generated.RecommendationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.generated.RecommendationResponse.getDefaultInstance()))
              .setSchemaDescriptor(new RecommendationServiceMethodDescriptorSupplier("StreamRecommendations"))
              .build();
        }
      }
    }
    return getStreamRecommendationsMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getRecommendations(distsys.generated.RecommendationRequest request,
        io.grpc.stub.StreamObserver<distsys.generated.RecommendationResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetRecommendationsMethod(), responseObserver);
    }

    /**
     */
    default void streamRecommendations(distsys.generated.RecommendationRequest request,
        io.grpc.stub.StreamObserver<distsys.generated.RecommendationResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getStreamRecommendationsMethod(), responseObserver);
    }
  }
  ...
  public static final class RecommendationServiceStub
    ...
    /**
     */
    public void getRecommendations(distsys.generated.RecommendationRequest request,
        io.grpc.stub.StreamObserver<distsys.generated.RecommendationResponse> responseObserver) {
    ...
    /**
     */
    public void streamRecommendations(distsys.generated.RecommendationRequest request,
        io.grpc.stub.StreamObserver<distsys.generated.RecommendationResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getStreamRecommendationsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class RecommendationServiceBlockingStub
    ...
    /**
     */
    public distsys.generated.RecommendationResponse getRecommendations(distsys.generated.RecommendationRequest request) {
    ...
    /**
     */
    public java.util.Iterator<distsys.generated.RecommendationResponse> streamRecommendations(
        distsys.generated.RecommendationRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
          getChannel(), getStreamRecommendationsMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class RecommendationServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<distsys.generated.RecommendationResponse> getRecommendations(
        distsys.generated.RecommendationRequest request) {
  ...
  private static final int METHODID_STREAM_RECOMMENDATIONS = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_RECOMMENDATIONS:
          serviceImpl.getRecommendations((distsys.generated.RecommendationRequest) request,
              (io.grpc.stub.StreamObserver<distsys.generated.RecommendationResponse>) responseObserver);
          break;
        case METHODID_STREAM_RECOMMENDATIONS:
          serviceImpl.streamRecommendations((distsys.generated.RecommendationRequest) request,
              (io.grpc.stub.StreamObserver<distsys.generated.RecommendationResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              distsys.generated.RecommendationRequest,
              distsys.generated.RecommendationResponse>(
                service, METHODID_GET_RECOMMENDATIONS)))
        .addMethod(
          getStreamRecommendationsMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              distsys.generated.RecommendationRequest,
              distsys.generated.RecommendationResponse>(
                service, METHODID_STREAM_RECOMMENDATIONS)))
        .build();
  }
  ...
  private static abstract class RecommendationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return distsys.generated.RecommendationProto.getDescriptor();
    }
      ...
      synchronized (RecommendationServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getStreamRecommendationsMethod())
              .build();
        }
      }
    }
